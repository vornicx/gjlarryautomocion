export const vehicles = [
  {
    ...
    equipment: [
      'Paquete M Sport','Techo panorámico','Asientos de cuero eléctricos con memoria','Climatizador de 3 zonas','Navegador','Apple CarPlay / Android Auto','Cámara trasera y cámaras de asistencia','Sensores de aparcamiento','Faros LED','Llantas M Sport','Modos Sport / Comfort / Eco Pro','Cuadro digital'
    ]
  }
];
...
export const euro = n => new Intl.NumberFormat('es-ES',{style:'currency',currency:'EUR',maximumFractionDigits:0}).format(n);
export const km = n => new Intl.NumberFormat('es-ES').format(n) + ' km';
export const dateEs = s => new Intl.DateTimeFormat('es-ES',{day:'2-digit',month:'short',year:'numeric'}).format(new Date(`${s}T12:00:00`));
